...
function Contents({ header, body, body2, design , img1 , img2 }) {
    ...
    switch (design) {
        case "A": {
            return (
                <div className="Section-A color-A" id='system' style={{ width: '100%', height: "50vh", display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: 'column' , padding:'5rem' }}>
        ...
        case "C": {
            return (
                <div className="Section-C color-b" style={{width: '100%', height: "50vh", display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        ...
        case "D": {
            return (
                <div className="Section-D color-A" id="cus"style={{width: '100%', height: "50vh", display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
